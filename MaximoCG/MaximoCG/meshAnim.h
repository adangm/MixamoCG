...
public:
    ...
    /*  Functions  */
    // constructor
	MeshAnim(vector<Vertex> vertices, vector<unsigned int> indices, vector<TextureM> textures)
	{
    ...
    MeshAnim(vector<Vertex> vertices, vector<unsigned int> indices, vector<TextureM> textures, vector<VertexBoneData> bone_id_weights)
    {
        this->vertices = vertices;
        this->indices = indices;
        this->textures = textures;
